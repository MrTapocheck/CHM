...
int generate_plot_script(const char* script_name) {
    ...
    fprintf(f, "plot 'plot.dat' u 1:2 w p pt 7 ps 1 lc 'red' t 'МКЭ', '' u 1:3 w l lw 2 lc 'blue' t 'Точное'\n");
    ...
    fprintf(f, "plot 'plot.dat' u 1:(log10($4 + 1e-30)) w lp pt 7 ps 0.7 lc 'green' t 'log_{10}(|ош|)'\n");
